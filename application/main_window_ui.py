...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/robot_green.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon3.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/robot_red.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.actionActivateRobot.setIcon(icon3)
        self.actionActivateRobot.setObjectName("actionActivateRobot")
        self.actionConfig = QtGui.QAction(parent=MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/gear.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionConfig.setIcon(icon4)
        self.actionConfig.setObjectName("actionConfig")
        self.actionExit = QtGui.QAction(parent=MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/quit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/chip-green.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon6.addPixmap(QtGui.QPixmap("../../robot/qrobot/icons/chip-red.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
        self.actionActivateComputer.setIcon(icon6)
